// Scientific applications involve many polynomials with varied degree. A polynomial is an expression consisting of variables and coefficients. Choose an appropriate data structure to represent the polynomial and perform addition of two polynomials
...
NODE addpoly(NODE poly1, NODE poly2, NODE poly)
{
    ...
    while (pres_p1 != NULL && pres_p2 != NULL)
    {
        ...
        {
            poly = insertr(pres_p1->c, pres_p2->c, poly);
            pres_p1 = pres_p1->link;
        }
        else if (pres_p1->p < pres_p2->p)
        {
            poly = insertr(pres_p2->c, pres_p1->c, poly);
